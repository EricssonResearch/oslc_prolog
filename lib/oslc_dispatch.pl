 ...
 * pattern of =|/ns/resource|=. The handler with the highest priority wins.
 */
...
% Select a supported content-type (=|application/rdf+xml|=, =|text/turtle|=
% are supported as well as their non-standard variations =|text/rdf+xml|=,
